...
void main(void)
{
    ...
    printf ("\nIngrese un caracter para verificar si es un digito: ");
    p1 = getchar ();
    if (isdigit(p1))
    ...
    fflush (stdin);
    printf ("\n\nIngrese un caracter para verificar si es una letra: ");
    p1 = getchar ();
    if (isalpha(p1))
    ...
    fflush (stdin);
    printf ("\n\nIngrese un caracter para verificar si es una letra minuscula: ");
    p1 = getchar();
    if (isalpha (p1))
        if (islower(p1))
