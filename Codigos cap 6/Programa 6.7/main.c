#include <stdio.h>
#include <stdlib.h>
//monto anual de cada producto.
//monto total de productos lacteos.
//producto mas vendido y monto de ventas.
...
void Lectura1(int A[][12])
{
    ...
    {
        A[MES-1][PRO-1] += CAN;
        printf ("Ingrese el mes, el producto y la cantidad vendida: ");
...
void Funcion3 (float A[], int C)
{
    ...
    printf ("\n\nProducto mas vendido: %d  \tVentas: %.2f ", TPR + 1, VEN);
}
