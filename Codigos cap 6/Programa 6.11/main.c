...
void LecturaV (float A[], int T)
{
    ...
    for (I = 0; I < T; I++)
    {
        printf ("\nPrecio fondo %d al 04/10/2005: ", I+1);
        scanf ("%f", &A[I]);
    }
}
...
void F3 (float A[], int F)
{
    ...
    printf ("Mejor fondo de inversion: %d  \tRendimiento: %6.2f", M+1, ME);
    printf ("Peor fondo de inversion: %d  \tRendimiento: %6.2f", P+1, PE);
}
